...
# Kept as requested for reference/testing.
BOT_TOKEN = "7991103091:AAHUauqaRLSAiwy3U2NOagCiDfDh1UBEcF0"
API_ID = 19989378
API_HASH = "b85b6b543d548b6bbfaa41ab619534dd"
...
async def process_message(chat_id, msg_id, user_id):
    try:
...
async def download_worker():
    ...
    while True:
        ...
        try:
            ...
            print(
                f"Starting at message {current}, "
                f"need {count} successful message(s)"
            )
            ...
            await bot.send_message(
                chat_id=user_id,
                text=f"✅ Finished sending {downloaded} message(s).",
            )
...
async def main():
    ...
    await client.start()
    print("Telethon user client logged in.")
